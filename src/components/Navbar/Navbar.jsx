...
const Navbar = () => {
  return (
    <div className="fixed bottom-0 w-full lg:right-0 lg:bottom-1/2 lg:translate-y-1/2 lg:w-auto bg-white dark:bg-navbg lg:bg-transparent lg:shadow-none shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] z-20">
